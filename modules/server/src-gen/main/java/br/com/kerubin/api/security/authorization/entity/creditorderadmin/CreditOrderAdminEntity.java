...
public class CreditOrderAdminEntity extends AuditingEntity {
	...
	@DecimalMin(value="0", inclusive=false, message="\"Valor do pedido\" deve ser maior do que zero.")
	...
	@PastOrPresent(message="\"Data de cancelamento\" não pode ser futura.")
	...
	public void assign(CreditOrderAdminEntity source) {
		if (source != null) {
	...
	public CreditOrderAdminEntity clone() {
		return clone(new java.util.HashMap<>());
	}
	
	public CreditOrderAdminEntity clone(java.util.Map<Object, Object> visited) {
		if (visited.containsKey(this)) {
			return (CreditOrderAdminEntity) visited.get(this);
		}
				
		CreditOrderAdminEntity theClone = new CreditOrderAdminEntity();
