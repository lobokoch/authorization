...
/* INDEXES */
CREATE INDEX sysuser_name_lower_idx ON sys_user (name);
CREATE INDEX sys_user_cnpj_cpf_idx ON sys_user (cnpj_cpf);
CREATE INDEX sys_user_email_idx ON sys_user (email);
CREATE INDEX tenant_name_lower_idx ON tenant (name);
CREATE INDEX creditorder_orderusername_lower_idx ON credit_order (order_user_name);
